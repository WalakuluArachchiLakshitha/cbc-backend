/**
 * Generates a styled HTML email for OTP delivery.
 * @param {Object} params
 * @param {number|string} params.otp - The one-time password
 * @param {string} params.firstName - Recipient's first name
 * @param {string} params.brandName - Brand/company name
 * @param {string} params.supportEmail - Support email address
 * @param {Object} params.colors - Theme colors: { accent, primary, secondary }
